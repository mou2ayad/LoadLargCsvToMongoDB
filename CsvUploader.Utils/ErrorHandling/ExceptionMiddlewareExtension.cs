...
namespace CsvUploader.Utils.ErrorHandling
{
    public static class ExceptionMiddlewareExtension
    {
        public static IApplicationBuilder UseCustomErrorHandler(this IApplicationBuilder app, ILogger log, string appName, bool isDevelopment)
        {
